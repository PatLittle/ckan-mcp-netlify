...
export const buildFormatPromptText = (serverUrl, format, rows) => `# Guided search: datasets by resource format
...
export const registerFormatPrompt = (server) => {
    server.registerPrompt(FORMAT_PROMPT_NAME, {
