...
export const buildThemePromptText = (serverUrl, theme, rows) => `# Guided search: datasets by theme
...
export const registerThemePrompt = (server) => {
    server.registerPrompt(THEME_PROMPT_NAME, {
