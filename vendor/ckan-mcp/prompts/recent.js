...
export const buildRecentPromptText = (serverUrl, rows) => `# Guided search: recent datasets
...
export const registerRecentPrompt = (server) => {
    server.registerPrompt(RECENT_PROMPT_NAME, {
