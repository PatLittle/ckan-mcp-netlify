...
export const buildOrganizationPromptText = (serverUrl, organization, rows) => `# Guided search: datasets by organization
...
export const registerOrganizationPrompt = (server) => {
    server.registerPrompt(ORGANIZATION_PROMPT_NAME, {
